#ifndef LUMENEH_MARKDOWN_H
#define LUMENEH_MARKDOWN_H

#include <gtk/gtk.h>

/* GObject data key used to mark hrule child anchors inserted into the buffer. */
#define TRAYMD_HRULE_ANCHOR_DATA "lumeneh-hr-anchor"
...
#define LUMENEH_LINK_URL_DATA "lumeneh-link-url"

/* Prefix for named text marks used as internal heading anchors. */
#define LUMENEH_ANCHOR_MARK_PREFIX "lumeneh-anchor-"

/* GObject data key used to mark table child anchors with parsed table data. */
#define LUMENEH_TABLE_ANCHOR_DATA "lumeneh-table-anchor"
/* GObject data key set on table anchors for hidden searchable index metadata. */
#define LUMENEH_TABLE_SEARCH_INDEX_DATA "lumeneh-table-search-index"
/* GObject data key set on table anchors for attached table widget instance. */
#define LUMENEH_TABLE_WIDGET_DATA "lumeneh-table-widget"
/* GObject data keys set on each table cell widget. */
#define LUMENEH_TABLE_CELL_ROW_DATA "lumeneh-table-cell-row"
#define LUMENEH_TABLE_CELL_COL_DATA "lumeneh-table-cell-col"
/* CSS classes for table search highlight states. */
#define LUMENEH_TABLE_CELL_MATCH_CLASS "lumeneh-table-cell-match"
#define LUMENEH_TABLE_CELL_CURRENT_CLASS "lumeneh-table-cell-current"

/* GObject data keys for image anchors and metadata. */
#define LUMENEH_IMAGE_ANCHOR_DATA "lumeneh-image-anchor"
#define LUMENEH_IMAGE_SRC_DATA "lumeneh-image-src"
#define LUMENEH_IMAGE_ALT_DATA "lumeneh-image-alt"
#define LUMENEH_IMAGE_WIDGET_DATA "lumeneh-image-widget"
...
typedef struct {
  ...
  gint start_offset;
  gint end_offset;
} LumenehTableSearchCellRange;

typedef struct {
  gint start_offset;
  gint end_offset;
  GArray *cells; /* LumenehTableSearchCellRange */
} LumenehTableSearchIndex;
